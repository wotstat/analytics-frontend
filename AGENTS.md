...
В этом проекте **не пишем юнит-тесты**, в том числе при исправлении багов. Не добавляй файлы юнит-тестов и инфраструктуру для них. Проверяй изменения через `bun run build`, ESLint и при необходимости вручную в браузере или на `/debug`.
