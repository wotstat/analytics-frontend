...
- `general/General.vue` — общая страница раздела с выбором региона и сезона; `rankDistribution/` — столбчатое распределение игроков по рангам и рейтингу с одиночным и множественным выбором.
