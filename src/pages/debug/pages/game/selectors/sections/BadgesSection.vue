<template>
  <DebugSection title="Бейджи выбранного" id="badges"
    ...
    <div class="debug-col">
      ...
      <p class="debug-note">
        Высота бейджа — 24px. Крестик появляется при наведении или фокусе: выезжает справа поверх текста
        с градиентным затемнением, не сдвигая соседние бейджи. На устройствах без наведения он виден постоянно.
        Пустой бейдж сохраняет минимальную ширину 24px; длинный текст за границами бейджа обрезается без многоточия.
      </p>
    </div>
