<template>
  <DebugSection title="Форматирование подписей" id="formatting"
    ...
    <p class="debug-note">
      ...
      Единственный ограничитель — <span class="debug-value">clipBy(new ChartClip('bottom' | 'left'))</span>, и он режет
      текст ровно по границе слота, без многоточия. Включи «клип подписей» и сравни, что торчит за пределы области.
    </p>
