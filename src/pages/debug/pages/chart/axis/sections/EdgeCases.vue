<template>
  <DebugSection title="Крайние случаи и заведомые поломки" id="edge-cases"
    ...
    <p class="debug-note">
      ...
      <span class="debug-value">calculateLabelsFrame</span> выходит первой же строкой с пустым кадром: при рендере
      публикуется пустой список уровней, ни подписей, ни тиков, старые линии уходят целиком. Ось и слоты на месте:
      ширина левого слота схлопывается до одного <span class="debug-value">labelOffset</span>.
