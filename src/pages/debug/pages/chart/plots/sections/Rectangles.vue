<template>
  <DebugSection title="RectangleArea: прямоугольные области" id="rectangle-area"
    ...
    <p class="debug-note">
      <b>Область по умолчанию не участвует в bounds.</b> Поэтому автофит её не видит: утащи x2 за правый край
      данных — график не расширится, область просто уедет за пределы. При необходимости это можно включить через
      <span class="debug-value">affectsBounds: true</span>; область вне ограниченной оси при этом вернёт пустые
      bounds и не повлияет на автофит второй оси.
    </p>
