<template>
  <DebugSection title="defs: градиенты и паттерны" id="gradients"
    ...
    <p class="debug-note">
      <b>Паттерну не хватает общей точки входа.</b> Из рендереров данных его умеют принимать RectangleArea и
      PolygonArea (<span class="debug-value">fillByPattern</span>); у AutoLine такого метода нет, поэтому здесь паттерн
