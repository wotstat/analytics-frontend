  ...
  <DebugPage title="Типы графиков"
    ...
    <DebugSection title="Рендереры данных и с чего начать" id="renderers"
      ...
      <p class="debug-note">
        ...
        и маски. Менять их у живого рендерера нечем, поэтому такие контролы пересоздают рендерер; заметки в секциях
        говорят, где именно и почему. Сам график при этом пересоздавать не нужно: у чарта есть
        <span class="debug-value">removePlot</span>, <span class="debug-value">removeSlot</span> и
        <span class="debug-value">removeDefs</span>, у группы — <span class="debug-value">removePlot</span>. Снятие
        вынимает корневой элемент из DOM и зовёт <span class="debug-value">detach</span>.
      </p>
