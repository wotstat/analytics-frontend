<template>
  <DebugSection title="newFeatureBadge" id="new-feature-badge"
    ...
    <p class="debug-note">
      ...
      коде сейчас не используются нигде: единственное боевое место (onslaught/Layout.vue) помечает фичу явным вызовом
      setFeatureVisit при заходе на страницу, а не через директиву на ссылке.
    </p>
