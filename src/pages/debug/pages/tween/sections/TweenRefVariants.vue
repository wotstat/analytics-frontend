<template>
  <DebugSection title="Два варианта useTweenRef" id="tween-ref-variants"
    ...
    <p class="debug-note">
      ...
      processed.ts. Формулировка в <span class="debug-path">docs/05-ui-kit.md</span> («Дубликат-вариант есть в
      src/composition/tween/useTweenRef.ts») на сегодня не соответствует действительности — либо второй вариант
      задумывался и не был дописан, либо остался забытым черновиком после рефакторинга.
    </p>
