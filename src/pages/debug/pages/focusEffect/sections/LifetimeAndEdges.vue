<template>
  <DebugSection title="Время жизни, края экрана и несколько эффектов" id="lifetime"
    ...
    <p class="debug-hint">
      «Дважды подряд» — два вызова на одной цели: в наборе окажутся две записи с независимыми таймерами, но оба вызова
      происходят в одном синхронном тике, поэтому обе рамки погаснут одновременно, а не в два шага.
    </p>
