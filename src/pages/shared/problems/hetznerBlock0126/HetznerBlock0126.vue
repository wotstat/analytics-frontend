<template>
  ...
  <ModalWindow :title="'Недоступность серверов'" :display="visible" @close="visible = false">
    ...
    <template #header-content>
      ...
      <div class="info">
        <p>
          19 января 2026 года с 16:00 МСК по 20 января 15:25 МСК сервер WotStat стал недоступен из-за проблем в
          дата-центре. <b>На данный момент проблема устранена.</b>
        </p>
