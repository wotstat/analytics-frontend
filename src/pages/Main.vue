  ...
  <div class="hidden-x">
    <div class="main center-container">
      ...
      <section class="intro">
        ...
        <div class="flex center">
          <p class="text-center mod-description">Полностью <b>бесплатная</b> пользовательская модификация с <a
              href="https://github.com/WOT-STAT/WOTMOD" target="_blank">открытым исходным кодом</a> для игры <a
              href="https://tanki.su/ru/game/" target="_blank">«Мир&nbsp;танков»</a> и <a
              href="https://worldoftanks.eu/en/game/" target="_blank">«World&nbsp;of&nbsp;Tanks»</a>, которая в фоновом
            режиме
            записывает игровые события и позволяет анализировать их и сравнвать с другими игроками.
          </p>
        </div>
      </section>
    </div>
    ...
    <section class="install fluid">
      <div class="center-container">
        ...
        <p><a :href="latestRelease.browser_download_url" target="_blank">Cкачайте</a> актуальную версию мода и
          переместите её в директорию: <code>{{ targetModPath }}</code></p>
      ...
      <div class="features">
        <div class="feature left">
          <div class="feature-description">
            <h3>Анализ боёв</h3>
            <p>Мод собирает информацию о боях, время в очереди, классы техники, карту, время в бою.</p>
            <p>Вы сможете просматривать эту информацию как персонально для себя, так и в среднем по серверу/уровню/танку
            </p>
          </div>
          <div class="image">
            <div class="card">
        ...
        <div class="feature">
          <div class="feature-description">
            ...
            <p>Мод собирает информацию о КАЖДОМ выстреле, запоминая куда он полетел в прицеле, в кого попал, сколько урона
              нанёс.</p>
            <p>Скорость собственного танка, а так же FPS и Ping в момент выстрела</p>
          </div>
          <div class="image">
        ...
        <div class="feature left">
          <div class="feature-description">
            <h3>Анализ урона</h3>
            <p>Мод собирает информацию о нанесённом уроне, пожарах, взрывах БК, ХП противника, фрагах.</p>
            <p>Инфографика отображает распределение урона, а так же подсчитывает число "нечестно" добитых и спасённых от
              смерти танков.</p>
          </div>
          <div class="image">
        ...
        <div class="feature">
          <div class="feature-description">
            ...
            <p>Можно анализировать свом показатели, а так же показатели каждого игрока в бою. Их урон, насвет,
              натанкованность, потраченное ХП, число выстрелов, пройденную дистанцию, время жизни
            </p>
          </div>
          <div class="image">
            <div class="card">
        ...
        <div class="feature left">
          <div class="feature-description">
            ...
            <p>На основе результатов боёв можно анализировать турбобои</p>
            <p>Турбобоем считаеются бои длительностью менее 5 минут, в которых разница во фрагах более 10</p>
            <p>Вы сможете сравнить число турбобоёв у себя и у других игроков на разных уровнях в разное время</p>
          </div>
          <div class="image">
            <div class="card">
        ...
        <div class="feature">
          <div class="feature-description">
            ...
            <p>В результате каждого боя мод запоминает список реальных ников всех игроков, это позволяет посчитать кто
              попадает с вами в бой излишне часото</p>
            <p>Инфографик отображает игроков которые были в боях с вами чаше всего, а так же их средний урон за вашу
              команду и против вас</p>
          </div>
          <div class="image">
    ...
    <section class="sql fluid">
      <div class="center-container">
        <h2>SQL</h2>
        <p>К базе данных со ВСЕМИ исодными данными есть доступ черз SQL. Если вы разбираетесь, то можете самостоятельно
        ...
        <ul>
          <li>Каждую минуту: запросов: 240, время выполненни: 60c</li>
          <li>Каждый час: запросов: 2000, время выполненни: 600c</li>
          <li>Каждый день: запросов: 2000, время выполненни: 600c</li>
        </ul>
      </div>
    </section>
