  ...
  <div class="hidden-x">
    ...
    <section class="install fluid">
      <div class="center-container">
        ...
        <p>
          Воспользуйтесь веб-установщиком в разделе <RouterLink to="/install">Скачать</RouterLink> или скачайте мод
          файлом и установите его вручную.
        </p>
...
import { CLICKHOUSE_URL, CURRENT_URL_PREFIX } from '@/shared/external/externalUrl'
