  ...
  <section class="vehicle-table" ref="table" :style="tableStyle">
    ...
    <div class="head mt-font">
      ...
      <button v-if="showLevel" class="heading"
        ...
        <span v-if="sortPosition('tankLevel')" class="sort-arrow">
          <span v-if="sortPosition('tankLevel') > 1" class="sort-number">{{ sortPosition('tankLevel') }}</span>
        </span>
      </button>
      ...
      <button v-if="showType" class="heading"
        ...
        <span v-if="sortPosition('tankType')" class="sort-arrow">
          <span v-if="sortPosition('tankType') > 1" class="sort-number">{{ sortPosition('tankType') }}</span>
        </span>
      </button>
      ...
      <button v-if="grouping === 'tanks'" class="heading"
        ...
        <span v-if="sortPosition('name')" class="sort-arrow">
          <span v-if="sortPosition('name') > 1" class="sort-number">{{ sortPosition('name') }}</span>
        </span>
      </button>
      ...
      <div class="values">
        <button v-for="slot in visibleSlots" :key="slot" class="heading"
          ...
          <span v-if="sortPosition(slot)" class="sort-arrow">
            <span v-if="sortPosition(slot) > 1" class="sort-number">{{ sortPosition(slot) }}</span>
          </span>
        </button>
      </div>
    </div>
...
import { vehicleGroupings, type VehicleGrouping, type VehicleSelection } from '../vehicleGrouping'
