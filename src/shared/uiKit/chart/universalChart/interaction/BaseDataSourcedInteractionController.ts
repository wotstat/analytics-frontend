import { BaseInteractionController, Delegate, Position } from './baseInteractionController/BaseInteractionController'
...
export abstract class BaseDataSourcedInteractionController extends BaseInteractionController {
