...
// export class XLables extends BaseLabels {

//   constructor(root: SVGGElement, private options: XAxisOptions) {
//     const padding = 'padding' in options && options.padding !== undefined ? options.padding : undefined
//     super(root, { padding })
//   }
