<template>
  <div class="header" ref="headerElement">
    <div class="upper-header warning">
      Основной сервер WotStat упал (30 января 01:30 МСК). Ведутся работы по восстановлению.
      <br>
      В 01:30 МСК сервер перестал отвечать на любые запросы.
      <br>
      Полностью потеряно подключение к одному из двух жестких дисков. На данный момент сервер на диагностики дата
      центра.
      <br>
      22:03 МСК - Сервер на физической диагностике в ДЦ. В поддержке сказали, что в обычно, в течение суток подобные
      проблемы решают.
      <hr>
      Резервная копия базы данных есть от 29.01 20:31 МСК.
      <br>
      Время простоя мода на позиции будет компенсировано.
    </div>
    <div class="main flex">
