<template>
  <div class="header" ref="headerElement">
    <div class="upper-header warning">
      ...
      <br>
      01:30 МСК – Сервер перестал отвечать на все запросы.
      <br>
      02:20 МСК – Запросил техподдержу хостера.
      <br>
      03:55 МСК - Сервер перезагрузили, не помогло. Ожидаю подключения KVM.
      <br>
      05:48 МСК - Вероятнее всего, повреждён один из двух дисков сервера. Был RAID0. Независимые бекапы есть.
      <hr>
